...
export default class user_find_mfm extends Component {
  constructor(props) {
    super(props);
  ...
  _findUSer = () => {
    if (this.state.userEmail != null) {
      ...
      axios
        .post(`https://farmasi-apps.herokuapp.com/find-email`, {
  ...
  _getDetailUser = () => {
    ...
    axios
      .post(`https://farmasi-apps.herokuapp.com/get-db`, {
  ...
  _changeMobileKey = () => {
    axios
      .post(`https://farmasi-apps.herokuapp.com/change-key`, {
        useruid: this.state.getid,
  ...
  _userForgotPass = () => {
    axios
      .post(`https://farmasi-apps.herokuapp.com/reset`, {
  ...
  _userVerified = () => {
    axios
      .post(`https://farmasi-apps.herokuapp.com/verified`, {
        usergetEmail: this.state.getEmail,
      })
      .then((res) => {
  ...
  _userDelete = () => {
    axios
      .post("https://farmasi-apps.herokuapp.com/remove-users", {
        useruid: this.state.getid,
      })
      .then((res) => {
        alert(`Reset Password has been Send ${res.data.data}`);
    ...
    return (
      ...
      >
        <Button
          ...
          onPress={() => this.props.navigation.navigate("scan-mfm")}
        />
