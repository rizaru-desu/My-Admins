...
export default class user_find_mkp extends Component {
  constructor(props) {
    super(props);
  ...
  _findUSer = () => {
    if (this.state.userEmail != null) {
      ...
      axios
        .post(`https://materi-keperawatan-apps.herokuapp.com/find-email`, {
  ...
  _getDetailUser = () => {
    ...
    axios
      .post(`https://materi-keperawatan-apps.herokuapp.com/get-db`, {
  ...
  _changeMobileKey = () => {
    axios
      .post(`https://materi-keperawatan-apps.herokuapp.com/change-key`, {
        useruid: this.state.getid,
  ...
  _userForgotPass = () => {
    axios
      .post(`https://materi-keperawatan-apps.herokuapp.com/reset`, {
  ...
  _userDelete = () => {
    axios
      .post("https://materi-keperawatan-apps.herokuapp.com/remove-users", {
        useruid: this.state.getid,
      })
      .then((res) => {
        alert(`Reset Password has been Send ${res.data.data}`);
    ...
    return (
      ...
      >
        <Button
          ...
          onPress={() => this.props.navigation.navigate("scan-mkp")}
        />
